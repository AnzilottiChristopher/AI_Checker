...
class GitHubAPIScraper:
    ...
    def search_ai_code_generator_files_with_pagination(self, max_repos_per_pattern: int = 10, min_stars: int = 0, existing_data: dict = None, extract_contacts: bool = False) -> dict:
        ...
        Skips existing results to get new data points and saves to database.
        ...
        for marker in ai_markers:
            ...
            try:
                ...
                logger.info(f"Found {repos_found} new repos/files for marker {marker} (skipped {skipped_count} existing)")
